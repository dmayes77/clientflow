...
export const createClientSchema = z.object({
  ...
  leadStatus: z.enum(["new", "contacted", "quoted", "won", "lost"]).optional(),
  source: z.string().max(50, "Source is too long").optional().nullable(),
});
...
export const updateClientSchema = z.object({
  ...
  leadStatus: z.enum(["new", "contacted", "quoted", "won", "lost"]).optional(),
  source: z.string().max(50, "Source is too long").optional().nullable(),
  convertedAt: z.string().datetime("Invalid date format").or(z.date()).optional().nullable(),
...
export const createPackageSchema = z.object({
  ...
  description: z.string().max(500, "Description is too long").optional().nullable(),
  price: z.number().positive("Price must be positive"),
  serviceIds: z.array(z.string().cuid("Invalid service ID")).min(1, "At least one service is required").optional(),
});
...
export const updatePackageSchema = z.object({
  ...
  description: z.string().max(500, "Description is too long").optional().nullable(),
  price: z.number().positive("Price must be positive").optional(),
  serviceIds: z.array(z.string().cuid("Invalid service ID")).optional(),
});
