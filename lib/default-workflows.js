...
export const DEFAULT_WORKFLOWS = [
  ...
  // ============================================================================
  // AUTOMATION WORKFLOWS (Using new action types)
  // ============================================================================
  {
    systemKey: "auto_confirm_booking_on_payment",
    name: "Auto-Confirm Booking on Payment",
    description: "Automatically confirm booking when payment is received",
    triggerType: "payment_received",
    delayMinutes: 0,
    active: false, // Off by default - tenant can enable if desired
    actions: [
      {
  ...
  {
    systemKey: "auto_create_invoice_on_booking",
    ...
    actions: [
      {
        type: "create_invoice",
        config: { dueInDays: 30, includeBookingTotal: true },
      },
    ],
  },
];
