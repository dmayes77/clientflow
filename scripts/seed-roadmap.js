...
const ROADMAP_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Contact Custom Fields Export", description: "Export contact custom fields to CSV with field mapping and column selection" },
      { title: "Virtual Scrolling for Large Lists", description: "Performance optimization for contacts and bookings lists with thousands of entries using virtualization" },
      { title: "Activity Timeline Pagination", description: "Paginated activity feed with infinite scroll and load-on-demand for better performance" },
      { title: "Mobile Bulk Actions", description: "Optimized mobile interface for bulk contact operations with swipe gestures and batch selection" },
      { title: "CSV Import Field Mapping", description: "Visual field mapping interface for CSV imports with column preview and auto-detection" },
      { title: "Saved Filter Presets", description: "Save and share custom filter combinations for contacts, bookings, and invoices" },
      { title: "Timeline Event Tracking", description: "Complete activity audit trail including tag additions/removals and field changes" },
      { title: "Timezone Management", description: "Multi-timezone support for bookings, notifications, and reporting with automatic conversion" },
    ],
  },
];
