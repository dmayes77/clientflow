...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        <Command className="**:[[cmdk-group-heading]]:text-muted-foreground **:data-[slot=command-input-wrapper]:h-12 **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 **:[[cmdk-input-wrapper]]:*:h-5 **:[[cmdk-input-wrapper]]:*:w-5 **:[[cmdk-input]]:h-12 **:[[cmdk-item]]:px-2 **:[[cmdk-item]]:py-3 **:[[cmdk-item]]:*:h-5 **:[[cmdk-item]]:*:w-5">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
...
function CommandInput({ className, ...props }) {
  return (
    <div
      ...
      className="flex h-sm items-center gap-2 border-b border-border px-2"
    >
