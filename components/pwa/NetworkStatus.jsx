...
export function NetworkStatus() {
  ...
  if (isOnline && showReconnected) {
    return (
      <div className="fixed top-0 left-0 right-0 z-100 animate-in slide-in-from-top-2" style={{ animationDuration: 'var(--animation-duration)', animationTimingFunction: 'var(--animation-timing)' }}>
