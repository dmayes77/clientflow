...
export default function WebhooksPage() {
  return (
    <div className="space-y-10">
        ...
        <div className="space-y-3">
          ...
          <div className="grid sm:grid-cols-3 gap-3">
            <div className="border rounded-lg p-3 text-center">
              ...
              <h3 className="et-text-xs font-medium text-zinc-900 mb-1">Event Occurs</h3>
            ...
            <div className="border rounded-lg p-3 text-center">
              ...
              <h3 className="et-text-xs font-medium text-zinc-900 mb-1">Webhook Sent</h3>
            ...
            <div className="border rounded-lg p-3 text-center">
              ...
              <h3 className="et-text-xs font-medium text-zinc-900 mb-1">You Process</h3>
      ...
      {/* Creating a Webhook */}
      <section>
        <h2 className="et-text-base font-semibold text-zinc-900 mb-3">Creating a Webhook Endpoint</h2>
  ...
  "created_at": "2025-01-10T14:30:00Z"
      ...
      {/* Available Events */}
      <section>
        <h2 className="et-text-base font-semibold text-zinc-900 mb-3">Available Events</h2>
        <div className="border rounded-lg divide-y">
          {events.map((event) => (
            <div key={event.name} className="flex items-center gap-3 p-2.5">
              ...
              <span className="et-text-xs text-zinc-500">{event.description}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Webhook Payload */}
      <section>
        <h2 className="et-text-base font-semibold text-zinc-900 mb-3">Webhook Payload</h2>
        <p className="et-text-sm text-zinc-600 mb-3">
  ...
  "data": {
    ...
    "service": {
      ...
      <section>
        ...
        <p className="et-text-sm text-zinc-600 mb-3">
          Each webhook includes a signature in the <code className="et-text-xs bg-zinc-100 px-1 py-0.5 rounded">X-ClientFlow-Signature</code> header.
...
app.post('/webhooks/clientflow', express.raw({ type: 'application/json' }), (req, res) => {
  ...
  res.status(200).send('OK');
      ...
      <section>
        ...
        <div className="space-y-3">
          <div className="flex gap-3 p-3 border rounded-lg">
            ...
            <div>
              <h3 className="et-text-xs font-medium text-zinc-900 mb-1">Respond quickly</h3>
          ...
          <div className="flex gap-3 p-3 border rounded-lg">
            ...
            <div>
              <h3 className="et-text-xs font-medium text-zinc-900 mb-1">Handle duplicates</h3>
              <p className="et-text-xs text-zinc-500">
          ...
          <div className="flex gap-3 p-3 border rounded-lg">
            ...
            <div>
              <h3 className="et-text-xs font-medium text-zinc-900 mb-1">Verify signatures</h3>
              <p className="et-text-xs text-zinc-500">
          ...
          <div className="flex gap-3 p-3 border rounded-lg">
            ...
            <div>
              <h3 className="et-text-xs font-medium text-zinc-900 mb-1">Use HTTPS</h3>
              <p className="et-text-xs text-zinc-500">
      ...
      <section>
        ...
        <div className="border rounded-lg divide-y">
          <div className="flex justify-between items-center p-2.5">
            <span className="et-text-xs text-zinc-700">Retry attempts</span>
            <span className="et-text-xs text-zinc-500">5 times</span>
          </div>
          <div className="flex justify-between items-center p-2.5">
            <span className="et-text-xs text-zinc-700">Retry schedule</span>
            <span className="et-text-xs text-zinc-500">1min, 5min, 30min, 2hrs, 24hrs</span>
          </div>
          <div className="flex justify-between items-center p-2.5">
            <span className="et-text-xs text-zinc-700">Timeout</span>
            <span className="et-text-xs text-zinc-500">30 seconds</span>
          </div>
        </div>
      </section>
      ...
      {/* Testing Webhooks */}
      <section>
        <h2 className="et-text-base font-semibold text-zinc-900 mb-3">Testing Webhooks</h2>
        <p className="et-text-sm text-zinc-600 mb-3">
      ...
      <section className="border-t pt-6">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          ...
          >
            <div>
              <h3 className="et-text-sm font-medium text-zinc-900 group-hover:text-primary mb-1">Payment Integration</h3>
              <p className="et-text-xs text-zinc-500">Accept payments with Stripe</p>
            </div>
          ...
          >
            <div>
              ...
              <p className="et-text-xs text-zinc-500">Explore all endpoints</p>
            </div>
            <ArrowRight className="w-4 h-4 text-zinc-400 group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
