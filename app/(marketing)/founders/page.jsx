  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-[280px_1fr] gap-10 md:gap-12 items-start">
              ...
              {/* Content */}
              <div>
                <p className="text-sm text-primary font-medium mb-2">The person behind ClientFlow</p>
                <h1 className="text-3xl md:text-4xl font-bold mb-2">David Mayes</h1>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">Why I Built ClientFlow</h2>
            ...
            <div className="mt-10 pt-8 border-t">
              <p className="text-sm text-muted-foreground mb-1">Got questions or feedback?</p>
              <a
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold mb-10 text-center">How I Approach Building</h2>
