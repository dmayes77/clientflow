  ...
  return (
    <div style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <p style={{ marginBottom: "24px", color: "#666" }}>
        Resize the browser to see responsive changes at 480px, 640px, and 1024px breakpoints.
      </p>
      ...
      <section style={{ marginBottom: "48px" }}>
        ...
        <div style={{ display: "flex", gap: "16px", alignItems: "center", marginBottom: "8px" }}>
          ...
          <ShadcnButton size="default">Default Button</ShadcnButton>
        </div>
      ...
      <section style={{ marginBottom: "48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
          <div>
            ...
            <div id="shadcn-computed" style={{ marginTop: "8px", padding: "12px", background: "#f5f5f5", borderRadius: "4px", fontSize: "12px", fontFamily: "monospace" }}>
          ...
          <div>
            ...
            <div id="baseui-computed" style={{ marginTop: "8px", padding: "12px", background: "#f5f5f5", borderRadius: "4px", fontSize: "12px", fontFamily: "monospace" }}>
              Click button to see computed styles
            </div>
          </div>
        </div>
      ...
      <section style={{ marginBottom: "48px" }}>
        ...
        <table style={{ borderCollapse: "collapse" }}>
          ...
          <tbody>
            <tr><td style={{ padding: "8px", fontFamily: "monospace" }}>--font-size-2xs</td><td>0.625rem</td><td>10px</td></tr>
            <tr><td style={{ padding: "8px", fontFamily: "monospace" }}>--font-size-xs</td><td>0.6875rem</td><td>11px</td></tr>
            <tr><td style={{ padding: "8px", fontFamily: "monospace" }}>--font-size-sm</td><td>0.8125rem</td><td>13px</td></tr>
            <tr><td style={{ padding: "8px", fontFamily: "monospace" }}>--font-size-base</td><td>0.875rem</td><td>14px</td></tr>
            <tr><td style={{ padding: "8px", fontFamily: "monospace" }}>--font-size-lg</td><td>1rem</td><td>16px</td></tr>
            <tr><td style={{ padding: "8px", fontFamily: "monospace" }}>--font-size-xl</td><td>1.125rem</td><td>18px</td></tr>
          </tbody>
        </table>
      </section>
    </div>
