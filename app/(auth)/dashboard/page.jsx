    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-xs text-zinc-500">Welcome back! Here's what's happening with your business.</p>
        </div>
                ...
                {topServices.map((service, index) => (
                  <div key={service.name} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-medium text-zinc-900 truncate">{service.name}</p>
              ...
              <div className="space-y-2">
                {upcomingBookings.map((booking) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-medium text-zinc-900 truncate">{booking.client?.name}</p>
                      <p className="text-[0.625rem] text-zinc-500">{booking.service?.name || booking.package?.name}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs font-medium text-zinc-900">{format(parseISO(booking.scheduledAt), "MMM d")}</p>
              ...
              <div className="space-y-2">
                {recentClients.map((client) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-medium text-zinc-900 truncate">{client.name}</p>
