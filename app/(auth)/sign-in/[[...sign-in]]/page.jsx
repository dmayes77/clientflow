    ...
    >
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl px-8 py-10 sm:px-10 sm:py-12">
        ...
        <button
          ...
          className="w-full h-12 sm:h-14 flex items-center justify-center gap-3 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors disabled:opacity-50"
        >
          {googleLoading ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex h-12 sm:h-14 border border-gray-300 rounded-lg overflow-hidden">
            ...
            <input
              ...
              className="flex-1 min-w-0 px-4 text-base outline-none bg-white text-gray-700 placeholder:text-gray-400"
              required
            />
          </div>
          ...
          <div className="flex h-12 sm:h-14 border border-gray-300 rounded-lg overflow-hidden">
            ...
            <button
              ...
              className="w-12 sm:w-14 shrink-0 flex items-center justify-center text-gray-400 hover:text-gray-600 bg-white border-l border-gray-300"
            >
